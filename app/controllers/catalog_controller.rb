class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name("creator_colmex", :facetable), label: "Creator", limit: 5
    ...
    config.add_index_field solr_name("creator_colmex", :stored_searchable), label: "Creator", itemprop: 'creator', link_to_search: solr_name("creator_colmex", :facetable)
    ...
    #config.add_show_field solr_name("orcid", :stored_searchable), label: "Orcid"
    config.add_show_field solr_name("creator_colmex", :stored_searchable), label: "Creator"
