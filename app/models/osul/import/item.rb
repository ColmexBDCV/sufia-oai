class Osul::Import::Item < ActiveRecord::Base
  # serialize :fid, Array 
  ...
  scope :unimported_items, -> {joins('LEFT JOIN osul_import_imported_items ON osul_import_imported_items.fid = osul_import_items.fid')
