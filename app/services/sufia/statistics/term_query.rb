  ...
  module Statistics
    ...
    class TermQuery
      ...
      def query
        ...
        json = solr_connection.get 'terms', params: { 'terms.fl' => term,'terms' => true,'q' => 'has_model_ssim:GenericWork', 'terms.sort' => 'count','terms.limit' => @limit,wt: 'json','json.nl' => 'map',omitHeader: 'true' }
        unless json
